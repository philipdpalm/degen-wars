...
export default function Home() {
  ...
  return (
    ...
    {/* {Nav} */}
       ...
       />
        <div className={style.options}>
            <a href="https://www.notion.so/degen-wars/Degen-Wars-White-Paper-92a2f1f74b544ebc993e6562b571f8cd?pvs=4" target="__blank" className={style.items}>Whitepaper</a>
    ...
    <div className={style.footer} id='contact'>
      ...
      <a href="https://t.me/degenwarsarbitrum" target="_blank"><FontAwesomeIcon icon={faTelegram} className='h-8 mx-2 hover:cursor-pointer' /></a>
        </div>
    </div>
    </div>
  )
