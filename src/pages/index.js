...
const style = {
  ...
  sectionHeader: `mb-16`,
  token: `text-sm bg-[#96BEDCff] border-[#1E2839ff] border-double border-[6px] text-[#293246ff] w-[50%] md:w-[40%] rounded-md p-12 md:text-xl lg:text-3xl inline-block mb-16 mt-8`,
  ...
  return (
    ...
    <div className={style.footer} id='contact'>
      ...
      <div className={style.footerLogos}>
        <Image src='https://i.ibb.co/tKzx2tb/arbitrum-logo.png' height={100} width={100} alt='arbitrum logo' />
